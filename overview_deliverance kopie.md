...
[^1]: <a href="http://www.sahd.div.ed.ac.uk">Semantics of Ancient Hebrew Database-website</a>; <a http://www.sahd.divinity.cam.ac.uk">University of Cambridge: SAHD-website</a>.

Entries have been completed for the verbs גאל, הושׁיע, הציל, מלט,עזר ,
פדה, פלט and פרק, in all conjugations, together with nouns from the same
...
‘very closely related to one another (p. 30): הושׁיע, הציל, חלץ, מלט,
עזר, פלט, פצה, פרק, and the Biblical Hebrew nouns etymologically related
to them. 
...
עזר is used with a human ‘subject’ in Jud. 5.23, which is taken to
...
and Sawyer’s examples produce the following oppositions: for הושׁיע there
are השפיל, מות , נפל (sc. into the hands of enemies), קצר (probably),
נדהם and שקר; for the other words there is only (for עזר) כחש. As Sawyer
...
consequences (blessing, praise, security), implication (by way of a
כי–clause) and poetic parallelism, the last indicating a relation to
ענה, שמע and רפא which suggests ‘readiness to intervene’ and ‘general
...
and not <i>s</i> (Sawyer 1972, 93-94; cf. also Sawyer 1975).
<!--[^5] -->
...
former. Sawyer treatsמלט (which occurs only in Hebrew) as a by-form of
...
for ‘rescue, escape’. Finally, three rarer words are discussed, חלץ, פרק
and פצה, the latter two being seen, in the meaning ‘save’, as loans from
Aramaic.
...
only Ps. 144 extends this to ‘deliver’.
...
also sees ‘separation’ as involved in some cases (nouns in 1 Sam. 4 and
Obad. 14; also the Dan. 4 BAram. occurrence).
...
SAHD centre in Cambridge correspond to the most widely attested members
of Sawyer’s inner ‘lexical group’, plus גאל, פדה and פרק. Among the less
...
**a.**  הושׁיע: We concur with the general view that the etymological
...
majority being instances of three nouns: יֵשַׁע, יְשׁוּעָה and תְּשׁוּעָה.
...
from שָׁוַע, like שׁוֹעַ in Is. 22.5) and provide no basis for a
connection between the two roots.


**b.**  עזר: This is the general Hebrew word for ‘help’, but it is only about
...
**c.**  הציל: This root is represented almost entirely by verbal forms, in no
...
<p id="Williams">**d.**  מלט and פלט : Our entry on פלט (by Williams) 
points out that it
...
**e.**  גאל: There has been much debate about the semantics of this word (see
...
**f.**  פדה: Again there has been much debate about this group of words. Our
...
**g.**  פרק: Only three occurrences of this verb and its related nouns (plus
...
especially with the Niphal). It also appears occasionally for עזר, הציל
...
ῥύομαι is the other main equivalent for הציל and it is preferred for
...
**Vulgate**: The pattern of renderings is very similar to the LXX, quite
...
The Latin equivalents bring 
 מלט ,הושׁיע
  and פלט close together, with the
...
**Targums**: סְעַד and סיע (but not עדר) are naturally used for עזר, but
...
פְּרַק is one of two words that between them provide most of the other
renderings for the lexical group in the Targums. It is almost
universally used for הושׁיע, גאל, פדה and Heb. פרק, and twice even for
עזר. But there are two instances of נצחנא, ‘victory’, for הושׁיע, and for
גאל there are two instances of קרב, indicating family relationship,
...
the Hithpael, and פְּצָא frequently appears in Pss, Job and Proverbs),
...
and ב(י)שֵׁיזֵ for others. What was seen as the significant difference
between them? In any case the groupings are probably significant: הושׁיע
linked with גאל, פדה and Heb. פרק; הציל with מלט and פלט.

**Peshitta**: The distribution of equivalents is very similar to the
...
<i>praq</i> is again the main equivalent for הושׁיע, גאל, פדה and Heb. פרק. In
the case of הושׁיע this extends to renderings of שׁוֹעַ and שׁוּעַ (cf.
Vulg. x1, Targ. x1). There are again two instances of הושׁיע being
...
פדה, but not at all apparently for הציל.
...
Vulg and Syr. (but not apparently in the Tg.). A more striking fact is the
...
links them both with פלט. On the other hand the rendering by פרק/<i>praq</i>
in the Tg. and Syr. makes it part of a ‘family’ which includes other
members of the lexical group: גאל, פדה and פרק. The divergence is not
...
הציל. First, it may be noted that the minority sense ‘remove’ is
recognised in some renderings of LXX (σκυλεύω), Vulg. and Tg. The use
...
strongly present in the regular renderings of הציל, פלט and also מלט
into Aramaic (Tg. generally שׁיזב, but some cases of פצי in the
Tg.<sup>K</sup>; Syr. generally <i>pṣy</i>, but also <i>šyzb</i>).

מלט and פלט. LXX marks a distinction between these words (and
...
from LXX deserves note) and in Tg. and Syr. by the shared use of שׁיזב,
פצי and פלט.

גאל. In all the Versions the same word, one which means or can mean
...
reflected. In LXX and Vulg. it is the ‘family’ dimension which is most
clear, from the use of ἀγχιστεύω and words like <i>propinquus</i> (this
dimension appears only infrequently, it seems, in Tg. and Syr.). In Tg.
and Syr. the reference to vengeance is marked either by the retention of
גאל
 as a loanword (in Tg.<sup>O</sup> and Tg.<sup>J</sup>) or by the use of 
 תבע/ <i>tbʿ</i>
(Palestinian Targums and Syr.). 
In Syr. <i>tbʿ</i> is, more surprisingly, also
...
sometimes reinforced by <i>pretium</i> in Vulg. References to family
...
פרק. In LXX and Vulg. words for ‘redeem’ are used where there is a
personal object, no doubt as a reflection of this sense in Aramaic;
elsewhere a variety of words for ‘removal’ are used. In Tg. and Syr. the
use of פרק/`prq</i> itself occurs more widely as a result of its various
...
equivalents for them. This is particularly noticeable in the Tg. and Syr.
where two Aramaic words predominate in each case (the Tg.<sup>K</sup> 
side with Syr. for some reason in the specific vocabulary used)
...
(and in Vulg. with פלט) or with גאל, פדה and פרק, implying perhaps
...
the separative preposition מן. הציל is the most frequent member of this
...
subject matter), but Esther does have the only case in BHeb. of הצלה (4.14)
and an occurrence of מלט (4.13), neither with a divine subject. Hebrew
inscriptions provide another possible test, but the few occurrences (1x
גאל; 4x הושׁיע; cf. גאלה on coins) are probably all in religious
...
For the abbreviations see: [Abbreviations](/sahd/miscellaneous/abbreviations).
...
<i>Papers Presented to the Fifth International Congress on Biblical Studies held at Oxford, 1973</i> (TU 126, Berlin: Akademie-Verlag, 1982), 151-56.
</div>
...
<i>Hamito-Semitica: Proceedings of a Colloquium Held by the Historical Section of the Linguistics Association (Great Britain) at the School of Oriental and African Studies, University of London, on the 18th, 19th and 20th of March 1970</i>
