...
<div><input id="download" title="Download/print the document" type="image" onclick="print_document()" src="../../images/icons/download3.png" alt="download" /></div><div><a id="shebanq" title="Word in SHEBANQ" href="https://shebanq.ancient-data.org/hebrew/word?id=1MGLHn" target="_blank"><img src="../../images/icons/shebanq.png" alt="shebanq"></a></div># מְגִלָּה <i>m<small><sup>e</sup></small>gillāh</i> – scroll
...
* κεφαλίς, ‘little head’ (dim. of κεφαλή),<sup id="fnref:5"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:5')">5</a></sup> ‘rounded top end, scroll’:<sup id="fnref:6"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:6')">6</a></sup> Ezek 2:9; 3:1, 2, 3; Ps 40:8 (LXX 39:8); Ezra 6:2 (Aram.);
* τόμος, ‘roll’:<sup id="fnref:7"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:7')">7</a></sup> 1 Esd 6:22, rendering of Aram. <span dir="rtl" lang="he">מְגִלָּה</span> in Ezra 6:2;
* χάρτης, ‘papyrus roll’:<sup id="fnref:8"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:8')">8</a></sup> Jer 36:23 (LXX 43:23);
* χαρτίον, ‘papyrus roll’ (dim. of χάρτης):<sup id="fnref:9"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:9')">9</a></sup> Jer 36:2, 4, 6, 14<small><sup>1,2</sup></small>, 20, 21, 25, 27, 28<small><sup>1,2</sup></small>, 29, 32 (LXX 43:2, 4, etc.).


<b><span id="AVPesh">b. Peshitta (Pesh)</span></b>: 

* <span dir="rtl">ܟܪܟܐ</span> (<i>kerkā</i>), ‘book, volume, tome’:<sup id="fnref:10"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:10')">10</a></sup> Ezek 2:9; 3:1, 2, 3;
...
* <span dir="rtl">ܪܝܫܐ</span> (<i>rīšā</i>), ‘head, top’:<sup id="fnref:11"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:11')">11</a></sup> Ps 40:8, with 
...
* <i>involutus</i>, ‘rolled up’ (from <i>involvere</i>, ‘to roll’):<sup id="fnref:12"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:12')">12</a></sup> Ezek 2:9;
* <i>liber</i>, ‘a book written for publication, volume, roll’:<sup id="fnref:13"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:13')">13</a></sup> Jer 36:25;
* <i>volumen</i>, ‘a roll of papyrus forming a book or part of a book, a roll of writing, a roll, book, volume’:<sup id="fnref:14"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:14')">14</a></sup> Jer 36:2, 4, 6, 14<small><sup>1,2</sup></small></small>, 20, 21, 23, 27, 28<small><sup>1,2</sup></small>, 29, 32; Ezek 3:1, 2, 3; Zech 5:1, 2; Ps 40:8 (Vg<small><sup>PsH</sup></small>); Ezra 6:2.
