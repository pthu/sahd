...
<div><input id="download" title="Download/print the document" type="image" onclick="print_document()" src="/sahd/images/icons/download3.png" alt="download" /></div># פָּרָק – piece of meat

Author(s):
[Graham I. Davies](../contributors/graham_i._davies.md)<br>
First published: 2010-07-31<br>Last update: 2024-06-30 <br>Citation: Graham I. Davies, פָּרָק – piece of meat, <br>                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                    Semantics of Ancient Hebrew Database (https://pthu.github.io/sahd), 2010 (update: 2024)
...
is also the reading of 1QIsa^(a) (see further below on Versions and
...
NEB, REB, NRSV, NIV; but not JB, ‘food’), as well as by BDB, p. 830. As
...
Noun, presumed <i>qatal</i>-type (only construct form survives in a vocalised text of Ancient Hebrew).

## 3. Syntagmatics


<b>A.1</b>  <span dir="rtl">פרק</span> is the subject of  <span dir="rtl">קרב</span> qal, ‘come near’, in 4Q385 f2 5 (though
the reading of the verb is somewhat uncertain and probably based on Ezek
37:7).
...
<b>A.4</b>   <span dir="rtl">פרק</span> occurs in a composite expression  <span dir="rtl">פרקו פרק אל</span>, ‘one joint (shall come near) to another’ (4Q386 f1 i:5), which indicates that a  <span dir="rtl">פרק</span> here forms part of a larger whole (though prior separation is also presupposed).

## 4. Ancient Versions

<b>a. Septuagint (LXX)</b>:

* ζωμός (θυσιῶν, μεμολυμμένα...), ‘’: Isa 65:4.

<b>b. Peshitta (Pesh)</b>:

* <span dir="rtl">ܛܘܫ</span> (<i>ṭwš</i>) <i>pael</i>, ‘to soil, profane’: Isa 65:4.

<b>c. Targum (Tg: J)</b>:

* (<span dir="rtl">פיגול</span>) <span dir="rtl">רטף</span>, ‘’: Isa 65:4<small><sup>J</sup></small>.

<b>d. Vulgate (Vg)</b>:

* <i>ius (profanum)</i>, ‘’: Isa 65:4.
...
is from <i>ṭwš</i>, and ‘by corpses’ [presumably reading  <span dir="rtl">פגרים</span> for  <span dir="rtl">פגלים</span>]) is
...
Pesh understanding of  <span dir="rtl">פרק</span> (or  <span dir="rtl">מרק</span>) as meaning ‘polluted’. It is of
...
<b>A.3</b>  In 4Q385 f2 the expression  <span dir="rtl">פרקו פרק אל</span> is preceded by  <span dir="rtl">עצמו עצם אל</span>,
‘one bone to another’, which (with the wider context and its basis in
Ezek 37, where  <span dir="rtl">עצמו עצם אל</span> occurs in v. 7) suggests that a  <span dir="rtl">פרק</span> is
...
<span id="ExA2"><b>A.2</b></span> In 4Q385 and 4Q386 the context seems to require a reference to bones
without flesh on them, and the placement after  <span dir="rtl">עצם</span> (cf. Syntagmatics)
points to ‘smaller bones, joints’ being meant. This fits a use of  <span dir="rtl">פֶּרֶק
<span dir="rtl">in later Heb. (see <span dir="rtl">פֶּרֶק</span>: Root and Etymology A.4), to which there are
possible parallels in Syriac (cf. ibid., A.6). The BH word  <span dir="rtl">מפרקת</span> (q.v.),
‘neck(-bone)’ may also be connected with this, in view of the
neck-bone’s composition from several small bones (vertebrae). The
vocalisation of the Qumran texts being uncertain, it may be better to
...
reviewed, since the vowels in MT relate to the Qere  <span dir="rtl">ומרק</span>.
