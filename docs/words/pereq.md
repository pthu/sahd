...
[^2]: Aquila (αʹ) and Symmachus (σʹ) are given according to Field<sup>II</sup>.
...
‘breaches (in the wall of the city)’ and ‘parting of the ways’,<sup id="fnref:3"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:3')">3</a></sup> citing versional and etymological support for these renderings (on the translation and textual note, see B.1 below).
