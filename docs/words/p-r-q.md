...
<div><input id="download" title="Download/print the document" type="image" onclick="print_document()" src="../../images/icons/download3.png" alt="download" /></div><div><a id="shebanq" title="Word in SHEBANQ" href="https://shebanq.ancient-data.org/hebrew/word?id=1PRQv" target="_blank"><img src="../../images/icons/shebanq.png" alt="shebanq"></a></div># פרק <i>pāraq</i> – to pull off, tear away
...
unclear (but see DJD XXXI, 252-54, 360, which suggests ‘redeemed’ [i.e. ‘forgave (faults)’] for the former passage). In Nabataean the sense ‘redeem’ is attested,<sup id="fnref:1"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:1')">1</a></sup> while in Jewish magical texts it means ‘loosen’ (a demon: better ‘remove’?)
