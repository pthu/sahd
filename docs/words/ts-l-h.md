...
35:13 – two of the Passover texts.<sup id="fnref:2"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:2')">2</a></sup>  <span dir="rtl">טוי</span> in Tgs does the same
...
course a long history of exegetical wrestling as it relates to this passage. If it were true, as some argue, that <span dir="rtl">בשׁל</span> is a generic cooking verb and can likewise mean ‘boil’ and simply ‘cook’, then there would be no contradiction between the two texts.<sup id="fnref:3"><a href="#footnote" data-toggle="modal" onclick="show_modal('fn:3')">3</a></sup> Exodus would still assert that the lamb is to be roasted and not ‘cooked in water’ (i.e. boiled),
...
[^2]: For more on the Passover texts, see <a href="#ExA1">Exegesis</a>. ὀπτάω also translates  <span dir="rtl">שׂרף</span> for baking bricks in Genesis 11:3. 
[^3]: For a representative set of examples, see Rashi <i>ad</i> Deut 16:7 and 2 Chron 35:13; Shachter 2003:75; Driver 1902:193–94; McConville 1984:117–18; Dillard 1987:285; Shaver 1989:116; Labuschagne 1990:98–99; Tigay 1996:155. 
