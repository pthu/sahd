...
<b>A.1</b>   <span dir="rtl">רָאָה</span> is the common Hebrew root for ‘to see’. In other Semitic languages, the root appears most commonly in Old South Arab. as <i>rʾy</i> , Eth. <i>rěʾěya</i> , and Arab. <i>raʾā</i> with the same meaning.[^3]
...
<b>A.5</b>  As a direct title  <span dir="rtl">רֹאֶה</span> is attributed to Samuel three times and once to Hanani in 1-2 Chronicles. In addition, the five attestations in 1 Samuel 9 all refer to Samuel as well, which means that eight out of thirteen attestations of the term refer to Samuel.[^6]
