...
title:   
semantic_fields: food_preparation    
...
35:13 – two of the Passover texts.[^2]  <span dir="rtl">טוי</span> in Tgs does the same
...
course a long history of exegetical wrestling as it relates to this passage. If it were true, as some argue, that <span dir="rtl">בשׁל</span> is a generic cooking verb and can likewise mean ‘boil’ and simply ‘cook’, then there would be no contradiction between the two texts.[^3] Exodus would still assert that the lamb is to be roasted and not ‘cooked in water’ (i.e. boiled),
